...
def main():
    ...
    "ambiguity: how ambiguous is the prompt? clear would mean that it is directly indicated that it is a deodorant stick, ambiguous would mean that the object is indirectly referenced."
    ...
    with open("./deodorant.csv", 'w') as f:
        writer = csv.writer(f)
